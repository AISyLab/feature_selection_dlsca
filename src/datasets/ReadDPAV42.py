...
class ReadDPAV42:
    ...
    def __init__(self, n_profiling, n_validation, n_attack, file_path="", target_byte=0, leakage_model="ID", first_sample=0,
                 number_of_samples=2000, reshape_to_cnn=False):
    ...
    def load_dataset(self, reshape_to_cnn=False):
        ...
        self.labels_key_hypothesis_validation = self.create_labels_key_guess(validation_plaintexts, self.round_key_validation)
